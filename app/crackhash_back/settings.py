"""
Django settings for crackhash_back project.
...
INSTALLED_APPS = [
    'crackhash_back.apps.MongoAdminConfig',
    'crackhash_back.apps.MongoAuthConfig',
    'crackhash_back.apps.MongoContentTypesConfig',
